<div class="row">
	...
	<div class="col-md-12">
		...
		<div class="row">
			...
			<h2 class="col-md-12">Client Information</h2>
			...
			<div class="form-group col-md-2">
				...
				{{ Form::text('golive_date', NULL, ['class' => 'form-control']) }}
		...
		<div class="row">
			...
			<h2 class="col-md-12">Project Information</h2>
		...
		<div class="row">
			...
			<h2 class="col-md-12">Estimate Information</h2>
